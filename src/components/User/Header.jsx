...
function Header({openLogout, isOpen, loading, searchOpen}) {
  ...
  return (
    <div className='fixed top-0 z-20 bg-secondary w-full p-3 px-5 md:px-7 justify-between flex h-20 lg:drop-shadow-md'>
        ...
        <div className='flex relative justify-center gap-3 sm:gap-5 lg:gap-7 items-center'>
            <img onClick={searchOpen} className='w-10 cursor-pointer hover:bg-[#facdcd] duration-300 p-2 overflow-visible bg-[#FFDEDE] rounded-full' src={search} alt="" />
