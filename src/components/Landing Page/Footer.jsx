...
function Footer({openCreator, openFaqs, openRules, openContact}) {
  return (
    <div className='w-full'> 
      <div className='relative bg-primary pt-4 mt-20 pb-8 flex gap-1 flex-col justify-center items-center rounded-t-3xl'>
        ...
        <div className='flex justify-evenly w-full'>
          <p onClick={openFaqs} className='text-white text-xs text-center leading-4 cursor-pointer border-b-2 hover:border-white border-transparent sm:text-sm px-3'>FAQs</p>
          <p onClick={openCreator} className='text-white text-xs text-center leading-4 cursor-pointer border-b-2 hover:border-white border-transparent sm:text-sm px-3'>The Creators</p>
        ...
        <p className='absolute bottom-1 left-1 text-[#FAFAFA] text-xs'>©2025 HomePaws</p>
      </div>
    </div>
