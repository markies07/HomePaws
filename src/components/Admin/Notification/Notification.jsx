...
function Notification() {
    ...
    const readNotif = async (postID, notificationID, notifType, applicationID, accepted, petID, reportID, reportType) => {
        ...
        if(notifType === 'like'){
            ...
            if(accepted){
                navigate(`/admin/profile/applications/accepted/${applicationID}`, {state: {notifType}});
            }
            else{
                navigate(`/admin/profile/applications/application/${applicationID}`, {state: {notifType}});
            }
        }
        else if(notifType === 'rehome'){
            navigate(`/admin/profile/applications/rehomed/${applicationID}`, {state: {notifType}});
        }
        else if(notifType === 'rejected'){
            navigate(`/admin/profile/applications/rejected/application/${applicationID}`, {state: {notifType}});
        }
        else if(notifType === 'closed'){
            navigate(`/admin/profile/applications/closed/application/${applicationID}`, {state: {notifType}});
        }
        else if(notifType === 'removed'){
            navigate(`/admin/find-pet/removed/${petID}`, {state: {notifType}});
        }
